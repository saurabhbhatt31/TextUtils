    ...
    <div className="container upperwrapper">
      <div className="container">
        <div className="my-3" style= {{color : props.mode==='light'?'black':'white'}}>
          ...
          <textarea  ref={textvalue}  className="form-control" onChange={handleOnchange} id="myTextBox" rows="3" value={text} style = {{color : props.mode==='light'?'black':'white',backgroundColor: props.mode==='dark'?'grey':'white'}}></textarea>
        </div>
